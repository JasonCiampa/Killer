...
public class TitleScreen extends Scene {
    ...
    public TitleScreen() {
        ...
        playButton = new ChangeSceneButton((this.width / 2) - (this.width / 4), (this.height / 2) - 50, "Play Game", "play", this, null);         // Creates a playButton that changes the Scene to casinoTable when clicked on
            
        quitButton = new Button((this.width / 2) - (this.width / 4), (this.height / 2) - 250, "Quit Game", "quit", this) {                                     // Creates a quitButton
            @Override
