...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    ...
    protected void draw(SpriteBatch batch) {                                                            
        ...
        if (this.rulesMenuActive) {                                                                                                        // If the rules menu is active...
            ...
            if (this.rulesCurrentPage == 0) {                                                                                              // If the first page is the current page of the rules menu...
                batch.setColor((float) 0.2, (float) 0.2, (float) 0.2, 1);                                                                    // Darken the drawing color
            ...
            if (!game.getPlayerInputAllowed()) {                                                                                               // If the Player isn't allowed to interact...
                ...
                batch.setColor((float) 0.2, (float) 0.2, (float) 0.2, 1);                                                                        // Darken the drawing color again (the Button's draw function resets the drawing color to default after completion)
